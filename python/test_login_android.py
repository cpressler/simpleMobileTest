...
class LoginTests(unittest.TestCase):
    ...
    def setUp(self):
        app = ('/Users/chesterpressler/development/appium/loginSimpleExample/android/LoginDemo/app/build/outputs/apk/debug/app-debug.apk')
...
#        emailTF.send_keys(Keys.RETURN)
        sleep(1)
        fieldValue = emailTF.get_attribute("text")
        self.assertEqual(fieldValue , "validEmail")
...
#        passwordTF.send_keys(Keys.RETURN)
        sleep(1)
        self.assertNotEqual(passwordTF.get_attribute("text"), "validPW")
    ...
    def testLogin(self):
        ...
        self.assertTrue(smiley.get_attribute('enabled'))
